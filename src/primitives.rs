...
pub fn capsule(height: f64, radius: f64) -> SerializedModel {
    let top_sphere_vertex = builder::vertex(Point3::new(0.0, radius, 0.0));
    ...
    let bottom_sphere_vertex = builder::vertex(Point3::new(0.0, -radius, 0.0));
    ...
    let temp = truck_shapeops::or(&top_sphere, &cylinder, 0.0005).unwrap();
