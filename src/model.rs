// FROM https://github.com/sotrh/learn-wgpu/blob/master/code/intermediate/tutorial12-camera/src/model.rs
...
safe_index::new! {
  NormalMappedTexturedMeshIndex,
  map: NormalMappedTexturedMeshes
}
