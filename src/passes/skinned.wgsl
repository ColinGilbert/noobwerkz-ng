...
fn vs_main(
    ...
    let bone_transform = (bone_matrices[num_bones * model.instance_index + model.bone_indices.x] * model.bone_weights.x) + (bone_matrices[num_bones * model.instance_index + model.bone_indices.y] * model.bone_weights.y) + (bone_matrices[num_bones * model.instance_index + model.bone_indices.z] * model.bone_weights.z) + (bone_matrices[num_bones * model.instance_index + model.bone_indices.w] * model.bone_weights.w);
